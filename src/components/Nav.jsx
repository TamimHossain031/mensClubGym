...
export default function Nav() {
  ...
  return (
    <nav className="px-2 py-5 flex justify-between relative z-10">
      ...
      {show && (
        <div className="absolute top-[100%] right-0 w-[100%] text-white bg-sky-500 py-4 pt-9 px-4 text-xs transition">
          <button
          ...
          <button className='float-right border px-2 py-1 rounded' onClick={()=> navigate('login')}>Login</button>
        </div>
      )}
    </nav>
  );
